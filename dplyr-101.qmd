...
white_wine |> 
  ...
  summarise(median(`residual sugar`),
            ...
            .by= `alcohol_class`)
```
Decoupe the values into different categories and we do breaks to give intervals, the intervals have to start before or at the smallest value and vice versa. 